        ...
        <footer id="contact" className=" border-t-1 border-[var(--custom-black-secondary)] lg:mt-30 md:mt-30 mt-10 bg-[var(--custom-black)] text-[var(--custom-white)] flex flex-col  items-center justify-center w-full p-4">
            <div className="lg:w-3/6 md:w-5/6 w-[90%]">
                <div className="w-full flex items-center">
                    ...
                    <div className="w-3/6 md:block lg:block hidden animate animate-right">
                        <img className="w-[80%]" src="logo_sf_hrz_white.png" alt="logo" />
                    </div>
                    <div className="lg:w-3/6 md:w-3/6 w-full space-y-6 py-6">
                        <h1 className="animate animate-show text-left lg:text-3xl md:text-3xl text-2xl font-semibold italic">Entre em contato</h1>

                        <div className="space-y-4">
                            <a className=" animate animate-show flex items-center pl-1" href="https://api.whatsapp.com/send?phone=5541999999999" target="_blank">
                                <CustomIcon icon="Whatsapp" className=" w-[2em] "></CustomIcon>
                                <p className="pl-2" >
                                    (41) 99282-1468</p>
                            </a>
                            <a className="animate animate-show flex items-center " style={{ paddingLeft: '2px' }} href="https://www.instagram.com/aluminiumengenharia/">
                                <CustomIcon icon="Instagram" className="w-[2.2em]"></CustomIcon>
                                <p className="pl-1.5">aluminiumengenharia</p>
                            </a>
                            <a className="animate animate-show flex items-center pl-1" href="mailto:contato@aluminumengengaria.com.br" target="_blank">
                                <CustomIcon icon="Email" className="w-[2em] "></CustomIcon>
                                <p className="pl-2">contato@aluminumengengaria.com.br</p>
                            </a>
                        </div>
                    </div>
                </div>
